...
namespace boost { 
	...
	namespace objects {
		...
		virtual boost::optional<unsigned> score(PyObject*) const = 0;
		...
		virtual boost::optional<unsigned> score(PyObject* args) const
		{
		    return detail::score<Caller>()(args);
		}
	    ...
	    {
		full_py_function_impl(Caller const& caller, 
				      unsigned min_arity, 
				      unsigned max_arity)
		    : m_caller(caller)
		...
		boost::optional<unsigned> score(PyObject* args) const
		{
		  return m_impl->score(args);
		}
