...
BOOST_PYTHON_DECL PyTypeObject const* 
registration::expected_from_python_type() const
{
...
BOOST_PYTHON_DECL PyTypeObject const* 
registration::to_python_target_type() const
{
    if (this->m_class_object != 0)
        return this->m_class_object;
...
BOOST_PYTHON_DECL PyTypeObject* 
registration::get_class_object() const
{
    if (this->m_class_object == 0)
    {
        ::PyErr_Format(
...
registration::to_python(void const volatile* source) const
{
