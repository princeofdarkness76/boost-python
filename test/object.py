...
>>> shouldthrow(AttributeError, obj_getattr)(x, 'foo')
>>> shouldthrow(AttributeError, obj_objgetattr)(x, 'objfoo')
>>> obj_setattr(x, 'foo', 1)
>>> x.foo
1
>>> obj_objsetattr(x, 'objfoo', 1)
>>> shouldthrow(TypeError, obj_objsetattr)(x, 1)
>>> x.objfoo
1
>>> obj_getattr(x, 'foo')
1
...
1
>>> shouldthrow(TypeError, obj_objgetattr)(x, 1)
...
>>> shouldthrow(AttributeError, obj_delattr)(x, 'foo')
>>> shouldthrow(AttributeError, obj_objdelattr)(x, 'objfoo')
